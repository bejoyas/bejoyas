...
2. On your server, clone the repo and install the requirements. Use a production server like `gunicorn` to run `app:app`.
3. In GoDaddy, add an A record for `howhot.me` that points to your server's IP address.
4. Restart the app whenever you push new changes to GitHub.
